	...
	{#if innerWidth > 767}
		...
		>
			<img 
				...
				alt="" 
			/>
			<div class="bg-[white]/50 absolute inset-0 grid grid-cols-2 grid-rows-[max-content,1fr,max-content] p-2 opacity-0 hover:opacity-100 group-focus:opacity-100 text-grey-1200 transition-opacity">
